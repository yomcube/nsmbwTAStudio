...
function players.player(player)
  local addr = player_addrs[player]
...
-- RNG --
rng.addr = syms.m_rnd__8dGameCom[reg]
...
function object.list()
  ...
  local objectNodeAddr = ReadValue32(syms.m_executeManage__10fManager_c[reg])
  local i = 1
